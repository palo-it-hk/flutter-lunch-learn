...
class CurrentWeatherResponse {
  ...
  factory CurrentWeatherResponse.fromJson(Map<String, dynamic> json) {
    ...
    final _uvIndex = json["uvindex"]["data"][0]["value"] as int;
    final _uvLevelDesc =
        (json["uvindex"]["data"][0]["desc"] as String).toUpperCase();
    final _weatherStatus =
        WeatherStatusExtension.fromValue((json["icon"] as List<dynamic>).first as int);

    // Parse stations
    final _stations =
        (json["temperature"]["data"] as List<dynamic>)
  ...
  factory CurrentWeatherResponse.dummy() {
